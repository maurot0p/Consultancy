            ...
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                ...
                <Typography variant="h5" align="center">
                  Comunica tu necesidad con nosotros.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                ...
                />
                <Typography variant="h5" align="center">
                  Nuestro equipo de profesionales trabajara para cumplir tu necesidad a la perfeccion
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                ...
                <Typography variant="h5" align="center">
                  ...
                  {'puedes optar por el mantenimiento.'}
                </Typography>
              </Box>
            </Grid>
          </Grid>
